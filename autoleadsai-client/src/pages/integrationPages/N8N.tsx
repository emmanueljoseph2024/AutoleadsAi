...
export default function N8nWorkflowsIntegrationPage() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 sm:gap-3 bg-blue-100 text-blue-700 px-4 sm:px-5 py-2 rounded-full text-xs sm:text-sm font-bold mb-6 sm:mb-8">
                {/* <FiWorkflow className="text-base sm:text-lg" /> */}
                Integration
              </div>
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Create advanced automation workflows connecting your entire lead
                generation pipeline for seamless data flow and execution.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-5">
                ...
                <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-2xl px-4 py-3 shadow-sm">
                  <FiGitBranch className="text-blue-600 text-lg" />
                  <span className="text-xs sm:text-sm md:text-base font-semibold">
                    Workflow Logic
                  </span>
                </div>
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    n8n enables automation of complex workflows by connecting
                    different systems in a visual and flexible way.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This allows seamless execution of lead generation processes.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    AI-enhanced workflows automatically process leads, trigger
                    actions and optimize pipeline efficiency.
                  </p>
                  ...
                  {[
                    {
                      ...
                      text: 'Start workflows based on lead or system events.',
                    },
                    {
                      icon: <FiLink />,
                      title: 'System Connections',
                      text: 'Connect APIs, databases and external tools easily.',
                    },
                    {
                      icon: <FiActivity />,
                      title: 'Real-time Execution',
                      text: 'Run workflows instantly as data changes.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Pipeline Optimization',
                      text: 'Improve lead flow and conversion efficiency.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    n8n workflows provide a scalable infrastructure for building
                    complex automation systems.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This ensures reliability and flexibility as your system grows.
                  </p>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      'Workflows automate lead processing',
                      'Systems connect without manual work',
                      'Triggers run actions in real time',
                      'AI improves workflow decisions',
                      'Pipeline efficiency increases significantly',
                    ].map((item, index) => (

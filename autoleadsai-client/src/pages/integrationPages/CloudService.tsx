...
export default function CloudServicesIntegrationPage() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 sm:gap-3 bg-blue-100 text-blue-700 px-4 sm:px-5 py-2 rounded-full text-xs sm:text-sm font-bold mb-6 sm:mb-8">
                <FiCloud className="text-base sm:text-lg" />
                Integration
              </div>
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Connect cloud-based services and automation tools for scalable
                workflows across your entire lead generation system.
                <span className="text-blue-600 font-semibold"> (incoming)</span>
              </p>

              <div className="flex flex-wrap items-center gap-3 sm:gap-5">

                <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-2xl px-4 py-3 shadow-sm">
                  <FiCloud className="text-blue-600 text-lg" />
                ...
                <div className="flex items-center gap-2 bg-yellow-50 border border-yellow-200 rounded-2xl px-4 py-3 shadow-sm">
                  <FiAlertCircle className="text-yellow-600 text-lg" />
                  <span className="text-xs sm:text-sm md:text-base font-semibold text-yellow-700">
                    Coming Soon
                  </span>
                </div>
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Cloud services enable seamless connection between distributed
                    systems, APIs and automation workflows.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This ensures data flows efficiently across all services.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    AI coordinates cloud-based tools to optimize workflow
                    execution and resource usage automatically.
                  </p>
                  ...
                  {[
                    {
                      icon: <FiCloud />,
                      title: 'Cloud Sync',
                      text: 'Synchronize data across all connected systems.',
                    },
                    {
                      icon: <FiLink />,
                      title: 'Service Connection',
                      text: 'Connect APIs and external platforms easily.',
                    },
                    {
                      icon: <FiActivity />,
                      title: 'Real-time Processing',
                      text: 'Process data instantly across cloud services.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Scalability',
                      text: 'Scale infrastructure without performance loss.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-3xl bg-yellow-100 text-yellow-600 flex items-center justify-center text-2xl shrink-0">
                      <FiAlertCircle />
                    </div>
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Cloud integration is currently in development and will enable
                    scalable infrastructure connections.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-yellow-700 font-semibold leading-relaxed">
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      'Cloud connects all automation tools',
                      'Data flows across systems instantly',
                      'AI optimizes cloud resource usage',
                      'Scalable infrastructure supports growth',
                      'APIs enable system-wide integration',
                    ].map((item, index) => (

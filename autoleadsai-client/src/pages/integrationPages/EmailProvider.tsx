...
export default function EmailProvidersIntegrationPage() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Integrate with SMTP providers and email tools for smart AI
                outreach and automated follow-ups that help convert leads
                efficiently across your pipeline.
              </p>
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Email providers connect directly to the AI system, allowing
                    automated outreach campaigns, follow-ups and lead nurturing
                    workflows.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This enables consistent communication with prospects without
                    manual sending or tracking.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    AI analyzes lead behavior and automatically triggers
                    personalized email sequences based on engagement and intent.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed">
                    This improves response rates and ensures timely follow-ups.
                  </p>
                  ...
                  {[
                    {
                      ...
                      text: 'Send emails automatically based on triggers and workflows.',
                    },
                    {
                      icon: <FiActivity />,
                      title: 'Engagement Tracking',
                      text: 'Monitor opens, clicks and replies in real time.',
                    },
                    {
                      icon: <FiDatabase />,
                      title: 'Lead Syncing',
                      text: 'Sync leads directly from social and AI detection systems.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Conversion Optimization',
                      text: 'Improve outreach performance with data-driven insights.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Email integrations create a scalable infrastructure for
                    outreach, allowing businesses to manage thousands of leads
                    efficiently.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This system ensures consistent communication and improved
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      'SMTP enables automated outreach systems',
                      'AI improves email personalization',
                      'Follow-ups increase conversion rates',
                      'Engagement tracking improves targeting',
                      'Email workflows scale lead generation',
                    ].map((item, index) => (

          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Monitor public business conversations, track engagement signals
                and discover opportunities directly from LinkedIn activity using
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    LinkedIn contains high-value professional conversations where
                    users discuss business needs, challenges and buying intent.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    AI systems monitor these interactions to identify potential
                    leads and opportunities automatically.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    The AI engine scans posts, comments and engagement patterns
                    to detect signals of interest and potential buying intent.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed">
                    This enables faster identification of relevant prospects
                  ...
                  {[
                    {
                      ...
                      text: 'Track public posts for relevant business conversations and intent signals.',
                    },
                    {
                      icon: <FiSearch />,
                      title: 'Engagement Analysis',
                      text: 'Analyze likes, comments and interactions to detect interest levels.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Opportunity Discovery',
                      text: 'Identify potential leads from active professional discussions.',
                    },
                    {
                      icon: <FiActivity />,
                      title: 'Real-Time Insights',
                      text: 'Receive live updates on high-value engagement activity.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black">
                      Scalable LinkedIn Intelligence
                    </h2>

                  </div>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    AI-driven LinkedIn monitoring allows businesses to scale
                    lead discovery across thousands of conversations
                    automatically.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This improves targeting accuracy, reduces manual effort and
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      'LinkedIn reveals high-intent business conversations',
                      'AI detects engagement-based interest signals',
                      'Posts and comments expose buying opportunities',
                      'Real-time monitoring improves response speed',
                      'Automation scales professional lead discovery',
                    ].map((item, index) => (

...
export default function AnalyticsPlatformsIntegrationPage() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Track campaign performance, replies, conversions and engagement
                metrics in one unified dashboard for complete visibility.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-5">
                ...
                <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-2xl px-4 py-3 shadow-sm">
                  <FiPieChart className="text-blue-600 text-lg" />
                  <span className="text-xs sm:text-sm md:text-base font-semibold">
                    Data Visualization
                  </span>
                </div>
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    All campaign data is centralized into a single analytics
                    dashboard for easy monitoring and evaluation.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This helps teams make faster and smarter decisions.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    AI processes engagement data instantly to surface actionable
                    insights for optimization.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed">
                    This improves conversion rates and campaign efficiency.
                  </p>
                  ...
                  {[
                    {
                      ...
                      text: 'Monitor all outreach campaigns in real time.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Conversion Metrics',
                      text: 'Track how leads turn into customers.',
                    },
                    {
                      icon: <FiActivity />,
                      title: 'Engagement Data',
                      text: 'Analyze user interactions across platforms.',
                    },
                    {
                      icon: <FiDatabase />,
                      title: 'Data Aggregation',
                      text: 'Combine data from multiple sources instantly.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Analytics platforms continuously monitor performance to
                    optimize campaign outcomes.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This ensures consistent growth and better ROI.
                  </p>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      'All metrics centralized in one place',
                      'Real-time campaign tracking enabled',

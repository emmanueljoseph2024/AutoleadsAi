...
export default function EmailOutreachTipsBlog() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-black leading-tight tracking-tight mb-6 sm:mb-8">
                Email Outreach Tips That Increase Replies
              </h1>

              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Learn how to craft high-performing email outreach campaigns that
                improve response rates through personalization, timing, and structure.
              </p>
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black">
                      Why Most Emails Don’t Get Replies
                    </h2>

                  </div>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Most outreach emails fail because they are too generic, too long,
                    or not relevant to the recipient’s actual needs.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    Without context or personalization, recipients ignore messages
                    that feel like mass marketing.
                  </p>
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black">
                      Writing Emails That Get Attention
                    </h2>

                  </div>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    Effective emails are short, personalized, and focused on a
                    specific problem or value proposition.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed">
                    The goal is to make the reader feel understood within the first
                  ...
                  {[
                    {
                      ...
                      text: 'Use real context about the recipient instead of generic templates.',
                    },
                    {
                      icon: <FiSend />,
                      title: 'Short Messaging',
                      text: 'Keep emails concise and focused on one clear value point.',
                    },
                    {
                      icon: <FiRepeat />,
                      title: 'Follow-up Strategy',
                      text: 'Send structured follow-ups instead of one-off messages.',
                    },
                    {
                      icon: <FiBarChart2 />,
                      title: 'Response Tracking',
                      text: 'Measure replies to optimize future outreach campaigns.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Email outreach will become increasingly automated but highly
                    personalized through AI systems.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This combination will significantly increase reply rates and

...
export default function AISystemsAPIDocumentationPage() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                ...
                including how signals are collected, processed and converted into
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    AI systems continuously collect signals from online platforms,
                    conversations and behavioral data to identify potential leads.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    These signals are processed using machine learning models to
                    determine intent and opportunity strength.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    The system analyzes engagement patterns, keywords and user
                    behavior to identify high-value opportunities in real time.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed">
                    This allows businesses to act on leads faster and with higher
                    precision.
                  </p>
                  ...
                  {[
                    {
                      ...
                      text: 'Gather data from conversations, searches and engagement activity.',
                    },
                    {
                      icon: <FiDatabase />,
                      title: 'Data Processing',
                      text: 'Organize and structure raw signals into usable insights.',
                    },
                    {
                      icon: <FiBarChart2 />,
                      title: 'Opportunity Scoring',
                      text: 'Rank leads based on intent strength and engagement level.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Predictive Analysis',
                      text: 'Forecast which leads are most likely to convert.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    AI systems transform raw behavioral data into structured
                    insights that support faster and more accurate business
                    decisions.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    This improves targeting, reduces wasted effort and increases
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      ...
                      'Behavioral data drives opportunity scoring',
                      'Real-time analysis improves accuracy',
                      'Machine learning enhances predictions',
                      'Systems continuously optimize results',
                    ].map((item, index) => (

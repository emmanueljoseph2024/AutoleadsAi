...
export default function AutomationWorkflowsApiDocPage() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Understand how AI lead generation and automated outreach systems
                work to intelligently discover, qualify, and engage potential leads.
              </p>
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    The automation system continuously scans social platforms,
                    analyzes conversations, and detects buying intent.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    It then triggers workflows to engage potential leads
                    automatically.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    Once a lead is detected, AI automatically generates
                    personalized outreach messages based on context.
                  </p>
                  ...
                  {[
                    {
                      ...
                      text: 'AI identifies buying signals in real time.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Lead Scoring',
                      text: 'Ranks leads based on intent strength.',
                    },
                    {
                      icon: <FiLayers />,
                      title: 'Workflow Automation',
                      text: 'Triggers actions based on predefined rules.',
                    },
                    {
                      icon: <FiDatabase />,
                      title: 'Data Processing',
                      text: 'Stores and processes lead intelligence.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    Automation workflows run continuously in the background,
                    ensuring leads are captured and engaged without manual effort.
                  </p>

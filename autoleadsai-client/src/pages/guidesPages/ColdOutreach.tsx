...
export default function ColdOutreachAutomationGuide() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Set up personalized email outreach campaigns that convert more
                leads into customers using AI-powered automation systems and
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Cold outreach automation helps businesses send personalized
                    messages to potential customers at scale without manually
                    managing every interaction.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    Intelligent systems organize campaigns, schedule emails and
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    AI systems analyze prospect data, conversation history and
                    engagement behavior to create more relevant outreach
                    experiences.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed">
                    Personalized communication improves open rates, replies and
                  ...
                  {[
                    {
                      ...
                      text: 'Automatically send emails at optimized times for engagement.',
                    },
                    {
                      icon: <FiActivity />,
                      title: 'Engagement Tracking',
                      text: 'Monitor opens, clicks and reply activity in real time.',
                    },
                    {
                      icon: <FiBarChart2 />,
                      title: 'Campaign Analytics',
                      text: 'Measure performance and improve outreach efficiency.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Higher Conversions',
                      text: 'Improve lead nurturing and increase customer acquisition.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black">
                      Smarter Outreach Systems
                    </h2>

                  </div>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Modern outreach systems combine automation, personalization
                    and analytics to create scalable lead generation workflows.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    Businesses using AI-powered outreach systems can increase
                    engagement while reducing manual prospecting workload.
                  </p>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      'Automation scales outreach campaigns',
                      'Personalization improves engagement',
                      'AI optimizes send timing',
                      'Analytics improve campaign performance',
                      'Smart workflows increase conversions',
                    ].map((item, index) => (
                      <div
                        key={index}

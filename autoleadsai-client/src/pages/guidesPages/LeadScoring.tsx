...
export default function LeadQualificationGuide() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Understand how AutoLeads AI identifies buying signals,
                prioritizes qualified opportunities and filters low-quality
                prospects automatically using intelligent scoring systems.
              </p>
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Lead qualification is the process of identifying whether a
                    prospect is likely to become a customer based on behavioral
                    signals and engagement activity.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    AI systems help businesses focus on high-quality leads while
                    removing low-intent prospects from outreach workflows.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    AutoLeads AI analyzes interactions, conversations,
                    engagement frequency and buying intent to assign lead scores
                    automatically.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed">
                    Higher scores indicate stronger purchase intent and a
                  ...
                  {[
                    {
                      ...
                      text: 'Automatically remove weak or low-intent prospects from campaigns.',
                    },
                    {
                      icon: <FiDatabase />,
                      title: 'Behavior Analysis',
                      text: 'Track engagement patterns and interactions across platforms.',
                    },
                    {
                      icon: <FiBarChart2 />,
                      title: 'Lead Scoring',
                      text: 'Assign scores based on relevance, activity and buying signals.',
                    },
                    {
                      icon: <FiTrendingUp />,
                      title: 'Conversion Prioritization',
                      text: 'Focus outreach efforts on prospects most likely to convert.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black">
                      Smarter Prospect Management
                    </h2>

                  </div>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Intelligent qualification systems help businesses scale
                    prospecting while maintaining lead quality and outreach
                    efficiency.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    Businesses using AI-driven scoring systems can reduce wasted
                    outreach and improve conversion performance significantly.
                  </p>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      'AI identifies qualified leads automatically',
                      'Lead scoring improves prioritization',
                      'Filtering removes low-quality prospects',
                      'Behavior tracking reveals buying intent',
                      'Automation increases conversion efficiency',
                    ].map((item, index) => (
                      <div
                        key={index}

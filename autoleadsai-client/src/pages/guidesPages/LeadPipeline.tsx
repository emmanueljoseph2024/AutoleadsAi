...
export default function ScalingLeadPipelineGuide() {
  return (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-black leading-tight tracking-tight mb-6 sm:mb-8">
                Scaling Your Lead Pipeline
              </h1>

              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 sm:mb-10">
                Build scalable workflows for finding, tracking and converting
                leads continuously using AI-powered systems and intelligent
              ...
              <div className="lg:col-span-2 space-y-10 sm:space-y-14">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Scalable lead pipelines allow businesses to consistently
                    generate, organize and convert leads without increasing
                    manual workload.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    Intelligent systems help teams manage larger volumes of
                    prospects while maintaining outreach quality and efficiency.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed mb-6">
                    AI systems automatically monitor prospect activity,
                    prioritize opportunities and optimize lead flow in real
                    time.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 leading-relaxed">
                    Businesses can scale prospecting operations without losing
                    personalization or response quality.
                  </p>
                  ...
                  {[
                    {
                      ...
                      text: 'Organize all lead activity and engagement data in one system.',
                    },
                    {
                      icon: <FiRefreshCw />,
                      title: 'Continuous Automation',
                      text: 'Keep workflows running automatically without manual repetition.',
                    },
                    {
                      icon: <FiBarChart2 />,
                      title: 'Performance Insights',
                      text: 'Measure conversion metrics and optimize pipeline performance.',
                    },
                    {
                      icon: <FiActivity />,
                      title: 'Real-Time Monitoring',
                      text: 'Track engagement behavior and lead progression instantly.',
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-6">
                    Businesses that automate lead generation and qualification
                    can scale customer acquisition more efficiently while
                    reducing operational bottlenecks.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                    Modern AI workflows make it possible to maintain consistent
                    lead flow, improve conversions and expand outreach capacity
                    continuously.
                  </p>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-4xl p-6 sm:p-8">
                  ...
                  <div className="space-y-5">
                    ...
                    {[
                      'Automation supports pipeline growth',
                      'AI improves lead management efficiency',
                      'Tracking systems increase visibility',
                      'Real-time insights optimize conversions',
                      'Scalable workflows reduce manual effort',
                    ].map((item, index) => (
                      <div
                        key={index}
